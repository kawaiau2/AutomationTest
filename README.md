...
### Git
  ...
  &nbsp;&nbsp;git remote add origin https://{{username}}:{{[Personal access tokens](https://xxx/plugins/servlet/access-tokens/manage "Click here to setup Personal access tokens")}}@xxx.biz/tribe/automation.git  
